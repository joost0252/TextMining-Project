...
script.tk <- script.tk %>% 
  ...
  c("sheldon","leonard","penny","howard","raj", 
      "amy", "bernadette", "emily", "cooper", "stuart", "lucy","arthur","rostenkowski","bert","mike","james","lorvis","dan","dr","beverly","isabella","williams","lesley","missy","dave","claire","meemaw", "mary","leslie","lalita","dennis,"alfred",
