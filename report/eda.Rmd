...
script.tk <- script.tk %>% 
  ...
  c("sheldon","leonard","penny","howard","raj", 
      "amy", "bernadette", "emily", "cooper", "stuart", "lucy","arthur","rostenkowski","bert","mike","james","lorvis","dan","dr","beverly","isabella","williams","lesley","missy","dave","claire","meemaw", 
      "scene", "series", "episode", "yeah","uh","hey","gonna","knock","dr","apartment","um","wanna","door")) 
