...
characters_names <- c("sheldon","leonard","penny","howard","raj", "amy", 
                      ...
                      "beverley","haley","mandy","adam","barry","mark","rebecca","randall","colonel")
...
```
Here, season 5 has the richest diversity, with a score of 0,5. 
...
- In the first graph, we analysis season 5 as the target. The reference is the rest of the corpus, and we observe that the word _'rothman'_ is the most used in the script of season 5 compared to the rest. 
