...
season.tk <- season.tk %>% 
  ...
  tokens_remove(
    c("sheldon","leonard","penny","howard","raj", 
      "amy", "bernadette", "emily", "cooper", "stuart", "lucy","arthur","rostenkowski","bert","mike","james","lorvis","dan","dr","beverly","isabella","williams","lesley","missy","dave","claire","meemaw", "mary","leslie","lalita","dennis","alfred", "susan", "ramona", "christie","gallo", "zack", "wil", "kurt","toby", "amelia","nathan","beverley","haley","mandy","adam","barry","mark",
      "scene", "series", "episode","pilot", "yeah","uh","hey","gonna","knock","dr","apartment","um","wanna","door")) 
      #remove main characters'name and 'scene'
season.tk
```
