...
ggplot(
  ...
  geom_tile() + xlab("") + ylab("")
```
From the Euclidean co-occurence matrix plot, it seems that season 4 is quite close to every other seasons. On the contrary, season 6 and season 2 are quite distant (but we know that there may be a problem in webscrapping).
...
## Co-occurences --> Still not working 
```{r}
...
## Cluster dendrogram --> Not working
```{r}
season.inv_occ <- 
  280 - as.matrix(
