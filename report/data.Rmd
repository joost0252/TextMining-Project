...
We define the corpus for our analysis. The corpus will be the scrips colomn in our dataset. Then we clean the texts by removing the numbers, the punctuation, the symbols, and the separators. 

In our scrips, we can see the main characters that are Sheldon, Leonard, Penny, Howard and Raj and they appear in all the sesaons' episodes. Therefore, we remove their name for the following explanatory data analysis because it will otherwise bias our results. 
...
script.tk <- script.tk %>% 
  ...
  tokens_remove(c("sheldon","leonard","penny","howard","raj"))  #remove main characters'name
```
